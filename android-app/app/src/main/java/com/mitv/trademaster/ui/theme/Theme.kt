...
// Alternate accent themes (selectable in Settings). Each is [primary, dim].
val ThemeAccents: Map<String, Pair<Color, Color>> = mapOf(
    "green" to (Color(0xFF34E39A) to Color(0xFF1A7A56)),
    "blue" to (Color(0xFF3B9EFF) to Color(0xFF1A4F8A)),
    "gold" to (Color(0xFFE3B934) to Color(0xFF7A6A1A)),
    "purple" to (Color(0xFFA46BFF) to Color(0xFF5A3A8A)),
)

fun accentFor(theme: String): Color = ThemeAccents[theme]?.first ?: BrandGreen
fun accentDimFor(theme: String): Color = ThemeAccents[theme]?.second ?: BrandGreenDim
